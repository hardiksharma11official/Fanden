...
function Carousel() {
  const slides = [
    {
      ...
      name: 'John Doe',
      review: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio neque, cupiditate consectetur quidem ad temporibus? Voluptate beatae veniam aspernatur dignissimos.'
    },
    {
  ...
  return (
    <div className='max-w-[1400px] h-full w-full m-auto py-16 px-4 relative group overflow-hidden'>
      <div
        className=' m-auto h-full rounded-2xl bg-center bg-cover duration-500 bg-gray-300'
      >
        <Card review={slides[currentIndex].review} name={slides[currentIndex].name} image={slides[currentIndex].image}/>
      </div>
